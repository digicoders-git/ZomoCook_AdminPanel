import {
  ...
  Badge, Button, Checkbox, Avatar, HStack, Switch
} from '@chakra-ui/react';
import {
  Filter, FileText, ArrowLeft, UserCheck, Clock, CheckCircle2, Calendar
} from 'lucide-react';
...
const HiredCandidatesList = () => {
  const candidates = [
    {
      ...
      jobState: 'Arunachal Pradesh',
      jobCity: 'Bomdila',
      demoPersonName: 'Shubham PHP Developer',
      demoPersonPhone: '9878264823',
      demoPersonAddress: 'Iko',
      demoDate: '30 Mar 2026',
      demoTime: '12:00 PM',
      scheduledAt: '28 Mar 2026 06:14 PM',
      rescheduleRequested: 'No',
      applyDate: '28 Mar 2026, 06:12 PM',
      shortlistDate: '28 Mar 2026, 06:13 PM',
      demoAt: '28 Mar 2026, 06:14 PM',
      hiredDate: '09 Apr 2026, 11:19 AM',
      showInApp: true,
      status: 'Hired',
    },
  ];
  ...
  return (
    <Box pb="10">
      <PageHeader
        title="Hired Candidates Records"
        breadcrumb="Hired Candidates Records"
      />

      <TableCard>
        <Flex px="5" py="4" borderBottom="1px solid #f1f5f9" align="center" justify="space-between">
          <HStack spacing="3">
            <Box w="3px" h="18px" bg="#00c853" borderRadius="full" />
            <Text fontSize="sm" fontWeight="700" color="#1e293b">Hired Candidates Records</Text>
          </HStack>
          <HStack spacing="2">
              ...
              {candidates.length > 0 ? (
                candidates.map((c, index) => (
                  <Tr key={c.id} {...trHover}>
                    ...
                    <Td {...tdStyle} textAlign="center" verticalAlign="middle">
                      <HStack spacing="2" justify="center">
                        <Switch isChecked={c.showInApp} colorScheme="orange" size="sm" />
                        <Text fontSize="xs" fontWeight="600" color="#475569">{c.showInApp ? 'Yes' : 'No'}</Text>
                      </HStack>
                    </Td>
                    <Td {...tdStyle} textAlign="center">
                      <VStack spacing="3" align="center">
                        <Button leftIcon={<UserCheck size={14} fill="white" />} size="sm" bg="#00c853" color="white" _hover={{ bg: '#00a444' }} borderRadius="4px" px="10" py="4" fontSize="13px" fontWeight="700" textTransform="none">
                          Hired
                        </Button>
                        <VStack spacing="1.5" w="full">
                          ...
                          <Badge
                            ...
                            border="1px solid #00c853"
                          >
                            <UserCheck size={12} /> Hired: {c.hiredDate}
                          </Badge>
                        </VStack>
                      </VStack>
                    </Td>
