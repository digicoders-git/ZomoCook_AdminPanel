...
import {
  Filter, FileText, ArrowLeft, PauseCircle, Clock, CheckCircle2, Calendar, Edit3
} from 'lucide-react';
...
const OnHoldCandidatesList = () => {
  const candidates = [
    {
      ...
      jobType: 'Full Time',
      jobPosition: 'Commis 1',
      vacancy: 3,
      joiningType: 'Standard',
      salaryRange: 'INR 20000 - 25000',
      experienceRange: '3 - 5 Years',
      clientName: 'The Grand Hotel',
      jobState: 'Karnataka',
      jobCity: 'Bangalore',
      demoPersonName: 'Chef Rahul',
      demoPersonPhone: '9001122334',
      demoPersonAddress: 'Indiranagar, Bangalore',
      demoDate: '20 Apr 2026',
      demoTime: '02:00 PM',
      scheduledAt: '12 Apr 2026 11:00 AM',
      rescheduleRequested: 'No',
      applyDate: '10 Apr 2026, 09:00 AM',
      shortlistDate: '11 Apr 2026, 10:30 AM',
      demoAt: '20 Apr 2026, 02:00 PM',
      holdAt: '21 Apr 2026, 12:00 PM',
      status: 'On Hold',
    },
  ];
  ...
  return (
    <Box pb="10">
      <PageHeader
        title="On Hold Candidates Records"
        breadcrumb="On Hold Candidates Records"
      />

      <TableCard>
        <Flex px="5" py="4" borderBottom="1px solid #f1f5f9" align="center" justify="space-between">
          <HStack spacing="3">
            <Box w="3px" h="18px" bg="#f59e0b" borderRadius="full" />
            <Text fontSize="sm" fontWeight="700" color="#1e293b">On Hold Candidates Records</Text>
          </HStack>
          <HStack spacing="2">
            <Button leftIcon={<Edit3 size={14} />} size="xs" variant="outline" borderColor="#ff6b00" color="#ff6b00" borderRadius="md" _hover={{ bg: '#fff7ed' }}>
              Update Status
            </Button>
              ...
              {candidates.length > 0 ? (
                candidates.map((c, index) => (
                  <Tr key={c.id} {...trHover}>
                    ...
                    <Td {...tdStyle} textAlign="center">
                      <VStack spacing="3" align="center">
                        <Button leftIcon={<PauseCircle size={14} fill="white" />} size="sm" bg="#f59e0b" color="white" _hover={{ bg: '#d97706' }} borderRadius="4px" px="10" py="4" fontSize="13px" fontWeight="700" textTransform="none">
                          On Hold
                        </Button>
                        <VStack spacing="1.5" w="full">
                          ...
                          >
                            <PauseCircle size={12} /> Hold At: {c.holdAt}
                          </Badge>
                        </VStack>
                      </VStack>
                    </Td>
...
export default OnHoldCandidatesList;
