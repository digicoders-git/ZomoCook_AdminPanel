...
const PERMISSION_MODULES = [
  ...
  { name: 'Cook Preference', permissions: ['Add Cook Preference', 'Cook Preference List'] },
  { name: 'Food Preference', permissions: ['Add Food Preference', 'Add Food Preference List'] },
  { name: 'Gender Preference', permissions: ['Add Gender Preference', 'Gender Preference List'] },
  { name: 'Service Duration', permissions: ['Add Service Duration', 'Service Duration List'] },
