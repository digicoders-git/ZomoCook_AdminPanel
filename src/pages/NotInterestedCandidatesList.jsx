...
import {
  Filter, FileText, ArrowLeft, CircleSlash, Clock, CheckCircle2, Calendar
} from 'lucide-react';
...
const NotInterestedCandidatesList = () => {
  const candidates = [
    {
      id: 1,
      candidateImage: null,
      ...
      state: 'Delhi',
      city: 'New Delhi',
      preferredCities: ['New Delhi', 'Gurgaon'],
      ...
      vacancy: 1,
      joiningType: 'Urgent',
      salaryRange: 'INR 30000 - 35000',
      experienceRange: '8 - 10 Years',
      clientName: 'Deluxe Bakery',
      jobState: 'Delhi',
      jobCity: 'New Delhi',
      demoPersonName: 'Manager Amit',
      demoPersonPhone: '9876543210',
      demoPersonAddress: 'Connaught Place, Delhi',
      demoDate: '25 Apr 2026',
      demoTime: '03:00 PM',
      scheduledAt: '15 Apr 2026 10:00 AM',
      rescheduleRequested: 'No',
      applyDate: '12 Apr 2026, 11:00 AM',
      shortlistDate: '13 Apr 2026, 02:00 PM',
      demoAt: '25 Apr 2026, 03:00 PM',
      notInterestedAt: '26 Apr 2026, 11:30 AM',
  ...
  return (
    <Box pb="10">
      <PageHeader
        title="Not Interested Candidates Records"
        breadcrumb="Not Interested Candidates Records"
      />

      <TableCard>
        <Flex px="5" py="4" borderBottom="1px solid #f1f5f9" align="center" justify="space-between">
          <HStack spacing="3">
            <Box w="3px" h="18px" bg="#64748b" borderRadius="full" />
            <Text fontSize="sm" fontWeight="700" color="#1e293b">Not Interested Candidates Records</Text>
          </HStack>
          <HStack spacing="2">
              ...
              {candidates.length > 0 ? (
                candidates.map((c, index) => (
                  <Tr key={c.id} {...trHover}>
                    ...
                    <Td {...tdStyle} textAlign="center">
                      <VStack spacing="3" align="center">
                        <Button leftIcon={<CircleSlash size={14} fill="white" />} size="sm" bg="#64748b" color="white" _hover={{ bg: '#475569' }} borderRadius="4px" px="10" py="4" fontSize="13px" fontWeight="700" textTransform="none">
                          Not Interested
                        </Button>
                        <VStack spacing="1.5" w="full">
                          ...
                          >
                            <CircleSlash size={12} /> Status At: {c.notInterestedAt}
                          </Badge>
                        </VStack>
                      </VStack>
                    </Td>
...
export default NotInterestedCandidatesList;
