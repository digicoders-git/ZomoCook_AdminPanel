...
const AppliedCandidatesList = () => {
  const appliedCandidates = [
    {
      id: 1,
      candidateImage: 'https://bit.ly/dan-abramov', // Placeholder
      name: 'Shubham vaish',
      gender: 'Male',
  ...
  return (
    <Box pb="10">
      <PageHeader
        title="Applied Candidates Record List"
        breadcrumb="Applied Candidates Record List"
        actions={[
      ...
      <TableCard>
        <Flex px="5" py="4" borderBottom="1px solid #f1f5f9" align="center">
          ...
          <Text fontSize="sm" fontWeight="700" color="#1e293b">Applied Candidates Record List</Text>
        </Flex>
        ...
        <TableFooter showing="1 to 1" total={1} />
      </TableCard>
      <PageFooter />
    </Box>
  );
